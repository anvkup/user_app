...
export default function CartItem(props) {
    ...
    return props.qty!=0 && <View style={styles.cartItem} key={a}>
                <Image source={{uri: `http://156.67.219.185:8000/api/getFile?uri=${props.img}`}} style={styles.image} />
