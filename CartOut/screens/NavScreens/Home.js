...
export default function Home(props, { navigation }) {
    ...
    useEffect(() => {
        async function getItems() {
            ...
            const response2 = await fetch('https://dev.virtualearth.net/REST/v1/Routes/DistanceMatrix?key=AkxGvhgT3xnAhq7df98kNAJ5Uu1V3qGiRIOIeykTllLqkqv6Vcoqlmqk9DLVOzBY', {
                method: 'post',
                headers: {
        ...
        const data2 = await response2.json()
        console.log('DATA', data2.resourceSets[0].resources[0].results);
        }
        getItems()
    }, [])
